                    ...
                    <Grid container spacing={2} justifyContent={"center"}>
                        ...
                        <Grid item xs={6}>
                            ...
                            <TextField
                                ...
                                defaultValue={formValues.statusId}
                                onChange={handleChange}
                                error={!!errors.statusId}
                                helperText={errors.statusId}
                            >
                                {listStatus.map((stt, index) => (
                                    <MenuItem key={index} value={stt.id}>
                                        {stt.statusName}
                                    </MenuItem>
                                ))}
                            </TextField>
                            ...
                            <Grid item xs={12}>
                                <Autocomplete
                                    ...
                                    value={formValues.listUserAsign?.map((id) =>
                                        listUser?.find((user) => user.id === id) || null
                                    )}
                                    onChange={(event, selectedOptions) => {
                                        setFormValues((prev) => ({
                                            ...prev,
                                            listUserAsign: selectedOptions.map((option) => option.id),
                                        }));
